`timescale 1ns / 1ps
//I've swapped in the logp module instead of log
//this causes the test set to fail but the design is still functionally correct, switching back to the
module AWGN_FINAL(
    ...
    //log module
    logp log_module(e, half_clk, u0_reg);
    
    //sqrt module
    sqrtp sqrt_module(f, e_reg);
    
    //cos module
    cosp cos_module(g0, g1, u1_reg);
    
    
    assign x0 = $signed({1'b0, f_reg})*g0_reg;
    assign x1 = $signed({1'b0, f_reg})*g1_reg;
