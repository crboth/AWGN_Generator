...
HD_PWD='C:/Users/Compy/Desktop/TexasLDPC/AWGN/AWGN.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log AWGN_FINAL.vds -m64 -mode batch -messageDb vivado.pb -notrace -source AWGN_FINAL.tcl
