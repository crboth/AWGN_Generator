%This script runs [loopmax] itertions of the AWGN and tracks the intermediate
%and final values so that they can be used in the RTL testbench, running
%dumpdata after this script generates the files
tic;
loopmax = 10000;
...
%uncomment or just run dumpdata to output values to test files
%dumpdata;
toc;
